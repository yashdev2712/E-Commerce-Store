  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="w-1/2 h-full flex flex-col justify-center items-center relative">
        <div className="absolute text-right flex left-0 top-0 items-center m-4 gap-3">
          <h1 className="text-xl font-semibold">Do'nt have an account?</h1>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div>
            <span className="text-xl font-semibold">Log in your account</span>
          </div>
